							...
							<form class="form" action="{{ route('package.update',$package->id) }}" method="post">
								...
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-lg-3">
											<div class="input-group">
												  <input type="number" name='package_price' value="{{ $package->package_price }}" placeholder='0.00' class="form-control" id="package_price" />
											</div>
									...
									<div class="form-group row">
										...
										<div class=" col-lg-3">
											<div class="input-group">
												<input type="number" name='package_amount' value="{{ $package->package_amount }}" id="package_amount" placeholder='0.00' class="form-control" />
										...
										<div class=" col-lg-3">
											<div class="input-group">
												 <input type="number" name='total_amount' value="{{ $package->total_amount }}" id="total_amount" placeholder='0.00' class="form-control" />
