							...
							<form class="form" action="{{ route('device.update',$device->id) }}" method="post">
								...
								<div class="card-body">
									<div class="form-group row">
										...
										<div class="col-lg-3">
											<input type="text" name="device"  class="form-control" value="{{ $device->device }}" placeholder="Enter Device Name"/>
									...
									<div class="form-group row">
										...
										<div class=" col-lg-3">
											<div class="input-group">
												<input type="text" name='model' value="{{ $device->model }}" id="" placeholder='Model Name' class="form-control" />
										...
										<div class=" col-lg-3">
											<div class="input-group">
												 <input type="text" name='district' value="{{ $device->district }}" id="" placeholder='District' class="form-control" />
									...
									<div class="form-group row">
										...
										<div class=" col-lg-3">
											<div class="input-group">
												<input type="number" name='lco_id'value="{{ $device->lco_id }}" id="" placeholder='LCO ID' class="form-control" />
